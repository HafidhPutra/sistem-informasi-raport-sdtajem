                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <form action="<?= route_to('register') ?>" method="post" class="user">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user <?php if (session('errors.nama_ayah')) : ?>is-invalid<?php endif ?>" name="nama_ayah" aria-describedby="nama_ayahHelp" value="<?= old('nama_ayah') ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <small id="passwordHelpBlock" class="form-text text-danger font-weight-bold">
                                        *isi username dengan nama lengkap tanpa spasi
                                    </small>
                                </div>

                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" class="form-control form-control-user <?php if (session('errors.email')) : ?>is-invalid<?php endif ?>" name="email" aria-describedby="emailHelp" value="@mail.com">
                                    <small id="passwordHelpBlock" class="form-text text-danger font-weight-bold">
                                        *isi email dengan nama lengkap tanpa spasi + @mail.com
                                    </small>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <small id="passwordHelpBlock" class="form-text text-danger font-weight-bold">
                                        *Gunakan password dengan kombinasi TANGGAL LAHIR + NISN
                                    </small>
                                </div>
