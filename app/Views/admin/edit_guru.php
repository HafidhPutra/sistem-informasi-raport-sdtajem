...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800">Form Ubah Data Guru</h1>
                ...
                <div class="card-body">
                    <div class="table-responsive font-weight-bold text-gray-700">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <!-- Tambah Data -->
                            <form action="/admin/guruupdate/<?= $admin['id'] ?>" method="post">
                                <?= csrf_field(); ?>
                                ...
                                <div class="form-group">
                                    <label>NIP</label>
                                    <input type="text" name="nip" class="form-control" autofocus value="<?= $admin['nip'] ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="text" name="email" class="form-control" autofocus value="<?= $admin['email'] ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Jabatan</label>
                                    <input type="text" name="jabatan" class="form-control" autofocus value="<?= $admin['jabatan'] ?>">
                                </div>

                                <div class="form-group">
                                    <label>Golongan</label>
                                    <input type="text" name="golongan" class="form-control" autofocus value="<?= $admin['golongan'] ?>">
                                </div>
