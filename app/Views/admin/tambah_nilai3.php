                ...
                <div class="card-body">
                    <div class="table-responsive font-weight-bold text-gray-700">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-user" name="id_kelas">
                                        ...
                                        <?php foreach ($kelas as $key) : ?>
                                            <option value="<?= $key['id_kelas'] ?>"><?= $key['nama_kelas'] ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            </div><br>
                            ...
                            <!-- H -->
                            <label class="h5 font-weight-bold text-primary">E. KETIDAKHADIRAN</label>
                            <div class="form-group">
                                <label>- Sakit</label>
                            ...
                            <!-- D -->
                            <label class="h5 font-weight-bold text-primary">F. CATATAN WALI KELAS </label>
                            <div class="form-group">
